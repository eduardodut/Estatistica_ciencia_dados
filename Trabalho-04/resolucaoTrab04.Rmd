...
>>>>>>> 47731c7ceb3936ca04bf41ce8c0a06ad944b9eb8
...
leveneTest(Tempo ~ Meet, 
           ...
           center=mean)
=======
leveneTest(Tempo ~ Meet, data=meet_file[meet_file$Meet == "Zoom" | meet_file$Meet == "Hangout", ], center=median)
```
**Para uma siginificância de 0,05 a hipótese nula pode ser rejeitada demonstrando que as amostras Zoom e Hangout podem ser originadas de populações distintas**
```{r teste entre Zoom e Hangout: média}
leveneTest(Tempo ~ Meet, data=meet_file[meet_file$Meet == "Zoom" | meet_file$Meet == "Hangout", ], center=mean)
>>>>>>> 47731c7ceb3936ca04bf41ce8c0a06ad944b9eb8
```
...
leveneTest(Tempo ~ Meet, 
           ...
           center=median)
=======
leveneTest(Tempo ~ Meet, data=meet_file[meet_file$Meet == "Skype" | meet_file$Meet == "Hangout", ], center=median)
>>>>>>> 47731c7ceb3936ca04bf41ce8c0a06ad944b9eb8
```
...
leveneTest(Tempo ~ Meet, 
           ...
           center=mean)
=======
leveneTest(Tempo ~ Meet, data=meet_file[meet_file$Meet == "Skype" | meet_file$Meet == "Hangout", ], center=mean)
>>>>>>> 47731c7ceb3936ca04bf41ce8c0a06ad944b9eb8
```
**Para uma siginificância de 0,05 a hipótese nula pode ser rejeitada demonstrando que as amostras Skype e Hangout podem ser originadas de populações distintas**
...
leveneTest(Tempo ~ Meet, 
           ...
           center=mean)
=======
leveneTest(Tempo ~ Meet, data=meet_file[meet_file$Meet == "Zoom" | meet_file$Meet == "Skype", ], center=median)
```
**Para uma siginificância de 0,05 a hipótes nula não pode ser rejeitada demonstrando que as amostras Zoom e Skype podem ser originadas de populações de variâncias semelhantes ou da mesma população**
```{r teste entre Zoom e Skype: média}
leveneTest(Tempo ~ Meet, data=meet_file[meet_file$Meet == "Zoom" | meet_file$Meet == "Skype", ], center=mean)
>>>>>>> 47731c7ceb3936ca04bf41ce8c0a06ad944b9eb8
```

**Para uma siginificância de 0,05 a hipótese nula não pode ser rejeitada demonstrando que as amostras Zoom e Skype podem ser originadas de populações de variâncias semelhantes ou da mesma população**
